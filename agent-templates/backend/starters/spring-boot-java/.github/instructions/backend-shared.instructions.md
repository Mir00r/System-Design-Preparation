---
description: "Use when implementing backend features, APIs, background jobs, persistence, messaging, service integrations, infrastructure configuration, or schema changes in Java services."
