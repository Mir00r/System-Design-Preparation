...
- Keep views thin and business logic outside transport handlers.
...
- If migrations are touched, run the repo's migration validation command before broad test execution.
