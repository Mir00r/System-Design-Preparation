---
description: "Use when implementing backend features in enterprise Java microservices that require strict API or event contracts, messaging semantics, observability, SLO-aware behavior, or controlled rollout and migration planning."
